...
export interface RoutingGraph extends GraphIdentity {
  ...
  // 0..254: how much height this edge climbs and drops, absolute, so it reads the same in either
  // direction. Saturates at a 12% average grade. 0 for a ferry and for a city with no DEM.
