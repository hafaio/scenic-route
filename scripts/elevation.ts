...
//
// It does NOT yet change how long a walk takes: the travel time is still a flat 1.4 m/s, so a route
// over a hill is still reported as if it were level. Grade-adjusted time is the other half of this
// and is not built.
//
